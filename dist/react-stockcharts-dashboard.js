...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainContainer = __webpack_require__(28);
	var MenuGroup = __webpack_require__(29);
	var MenuItem = __webpack_require__(30);
	var ContentSection = __webpack_require__(31);
	var Row = __webpack_require__(32);
	var Section = __webpack_require__(33);
	var ScrollMixin = __webpack_require__(34);
	...
	function renderPage(data, dataFull) {
		...
		var AreaChartWithZoomPan = __webpack_require__(17).init(data);
		var CandleStickStockScaleChart = __webpack_require__(13).init(data);
		...
		var CandleStickChartWithLotsOfData = __webpack_require__(22).init(dataFull);
		var HeikinAshiChart = __webpack_require__(23).init(data);
		var Kagi = __webpack_require__(26).init(dataFull);
		var PointAndFigure = __webpack_require__(24).init(data);
		var Renko = __webpack_require__(25).init(dataFull);
						...
						React.createElement(MainContainer, null, 
							React.createElement(Sidebar, null, 
								React.createElement(MenuGroup, null, 
									...
									React.createElement(MenuItem, {label: "Renko"}), 
							...
							React.createElement(ContentSection, {title: "Getting Started"}, 
								...
								React.createElement(Row, {title: "Renko"}, 
									React.createElement(Section, {colSpan: 2}, 
