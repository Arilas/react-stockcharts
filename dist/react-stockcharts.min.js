...
/***/ function(module, exports, __webpack_require__) {
	...
	// Tooltips
	exports.tooltip = {
		MACDTooltip: __webpack_require__(27),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassA=React.Component;for(var ____ClassA____Key in ____ClassA){if(____ClassA.hasOwnProperty(____ClassA____Key)){CompareSeries[____ClassA____Key]=____ClassA[____ClassA____Key];}}var ____SuperProtoOf____ClassA=____ClassA===null?null:____ClassA.prototype;CompareSeries.prototype=Object.create(____SuperProtoOf____ClassA);CompareSeries.prototype.constructor=CompareSeries;CompareSeries.__superConstructor__=____ClassA;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassD=React.Component;for(var ____ClassD____Key in ____ClassD){if(____ClassD.hasOwnProperty(____ClassD____Key)){HistogramSeries[____ClassD____Key]=____ClassD[____ClassD____Key];}}var ____SuperProtoOf____ClassD=____ClassD===null?null:____ClassD.prototype;HistogramSeries.prototype=Object.create(____SuperProtoOf____ClassD);HistogramSeries.prototype.constructor=HistogramSeries;HistogramSeries.__superConstructor__=____ClassD;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassE=React.Component;for(var ____ClassE____Key in ____ClassE){if(____ClassE.hasOwnProperty(____ClassE____Key)){KagiSeries[____ClassE____Key]=____ClassE[____ClassE____Key];}}var ____SuperProtoOf____ClassE=____ClassE===null?null:____ClassE.prototype;KagiSeries.prototype=Object.create(____SuperProtoOf____ClassE);KagiSeries.prototype.constructor=KagiSeries;KagiSeries.__superConstructor__=____ClassE;function KagiSeries(){if(____ClassE!==null){____ClassE.apply(this,arguments);}}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassG=React.Component;for(var ____ClassG____Key in ____ClassG){if(____ClassG.hasOwnProperty(____ClassG____Key)){RenkoSeries[____ClassG____Key]=____ClassG[____ClassG____Key];}}var ____SuperProtoOf____ClassG=____ClassG===null?null:____ClassG.prototype;RenkoSeries.prototype=Object.create(____SuperProtoOf____ClassG);RenkoSeries.prototype.constructor=RenkoSeries;RenkoSeries.__superConstructor__=____ClassG;function RenkoSeries(){if(____ClassG!==null){____ClassG.apply(this,arguments);}}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassH=React.Component;for(var ____ClassH____Key in ____ClassH){if(____ClassH.hasOwnProperty(____ClassH____Key)){MACDSeries[____ClassH____Key]=____ClassH[____ClassH____Key];}}var ____SuperProtoOf____ClassH=____ClassH===null?null:____ClassH.prototype;MACDSeries.prototype=Object.create(____SuperProtoOf____ClassH);MACDSeries.prototype.constructor=MACDSeries;MACDSeries.__superConstructor__=____ClassH;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassN=React.Component;for(var ____ClassN____Key in ____ClassN){if(____ClassN.hasOwnProperty(____ClassN____Key)){OHLCTooltip[____ClassN____Key]=____ClassN[____ClassN____Key];}}var ____SuperProtoOf____ClassN=____ClassN===null?null:____ClassN.prototype;OHLCTooltip.prototype=Object.create(____SuperProtoOf____ClassN);OHLCTooltip.prototype.constructor=OHLCTooltip;OHLCTooltip.__superConstructor__=____ClassN;function OHLCTooltip(){if(____ClassN!==null){____ClassN.apply(this,arguments);}}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassP=React.Component;for(var ____ClassP____Key in ____ClassP){if(____ClassP.hasOwnProperty(____ClassP____Key)){OHLCTooltip[____ClassP____Key]=____ClassP[____ClassP____Key];}}var ____SuperProtoOf____ClassP=____ClassP===null?null:____ClassP.prototype;OHLCTooltip.prototype=Object.create(____SuperProtoOf____ClassP);OHLCTooltip.prototype.constructor=OHLCTooltip;OHLCTooltip.__superConstructor__=____ClassP;function OHLCTooltip(){if(____ClassP!==null){____ClassP.apply(this,arguments);}}
		Object.defineProperty(OHLCTooltip.prototype,"render",{writable:true,configurable:true,value:function() {
			var displayDate, fromDate, toDate, open, high, low, close, volume;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassO=React.Component;for(var ____ClassO____Key in ____ClassO){if(____ClassO.hasOwnProperty(____ClassO____Key)){CompareTooltip[____ClassO____Key]=____ClassO[____ClassO____Key];}}var ____SuperProtoOf____ClassO=____ClassO===null?null:____ClassO.prototype;CompareTooltip.prototype=Object.create(____SuperProtoOf____ClassO);CompareTooltip.prototype.constructor=CompareTooltip;CompareTooltip.__superConstructor__=____ClassO;function CompareTooltip(){if(____ClassO!==null){____ClassO.apply(this,arguments);}}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassQ=React.Component;for(var ____ClassQ____Key in ____ClassQ){if(____ClassQ.hasOwnProperty(____ClassQ____Key)){SingleMAToolTip[____ClassQ____Key]=____ClassQ[____ClassQ____Key];}}var ____SuperProtoOf____ClassQ=____ClassQ===null?null:____ClassQ.prototype;SingleMAToolTip.prototype=Object.create(____SuperProtoOf____ClassQ);SingleMAToolTip.prototype.constructor=SingleMAToolTip;SingleMAToolTip.__superConstructor__=____ClassQ;function SingleMAToolTip(){if(____ClassQ!==null){____ClassQ.apply(this,arguments);}}
	...
	var ____ClassR=React.Component;for(var ____ClassR____Key in ____ClassR){if(____ClassR.hasOwnProperty(____ClassR____Key)){MovingAverageTooltip[____ClassR____Key]=____ClassR[____ClassR____Key];}}var ____SuperProtoOf____ClassR=____ClassR===null?null:____ClassR.prototype;MovingAverageTooltip.prototype=Object.create(____SuperProtoOf____ClassR);MovingAverageTooltip.prototype.constructor=MovingAverageTooltip;MovingAverageTooltip.__superConstructor__=____ClassR;function MovingAverageTooltip(){if(____ClassR!==null){____ClassR.apply(this,arguments);}}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassS=React.Component;for(var ____ClassS____Key in ____ClassS){if(____ClassS.hasOwnProperty(____ClassS____Key)){Canvas[____ClassS____Key]=____ClassS[____ClassS____Key];}}var ____SuperProtoOf____ClassS=____ClassS===null?null:____ClassS.prototype;Canvas.prototype=Object.create(____SuperProtoOf____ClassS);Canvas.prototype.constructor=Canvas;Canvas.__superConstructor__=____ClassS;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____ClassU=React.Component;for(var ____ClassU____Key in ____ClassU){if(____ClassU.hasOwnProperty(____ClassU____Key)){EventHandler[____ClassU____Key]=____ClassU[____ClassU____Key];}}var ____SuperProtoOf____ClassU=____ClassU===null?null:____ClassU.prototype;EventHandler.prototype=Object.create(____SuperProtoOf____ClassU);EventHandler.prototype.constructor=EventHandler;EventHandler.__superConstructor__=____ClassU;
		function EventHandler(props, context) {
			____ClassU.call(this,props, context);
			this.handleMouseMove = this.handleMouseMove.bind(this);
